...
- **Remaining review backlog (NOT done):** M1 query timeout, M2 rate-limit/proxy, M3 audit hash-chain, M4 defusedxml, M5 systemd hardening, M6 error scrubbing, L1–L6 — see STATUS.md "Security hardening backlog".
